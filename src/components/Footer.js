    ...
    <div>
      ...
      <div className="social-icons-bar">
        <div className="devprogress">
          <a data-action="donate"
            ...
            target="donate">
            <img src="https://devprogress.us/debate-bingo/images/hillary-logo.svg" className="donateButton" alt="donate button" />
           </a> &nbsp;
          <a data-action="donate"
            href="https://www.hillaryclinton.com/donate/?amount=10.00&utm_source=debate-bingo"
            target="donate">
      ...
      <div className="social-icons-bar">
        ...
        <div className="attribution">
          Bingo winner images by Gage Skidmore, licensed under <a
          href="https://creativecommons.org/licenses/by-sa/2.0/">Creative Commons</a>
        </div>
      </div>
     </div>
    );
