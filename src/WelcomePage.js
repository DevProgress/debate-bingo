    ...
    render() {
        return (
            <div>
                ...
                <Footer heading="Share Debate Bingo!" title="Make watching the presidential debate more fun! Play bingo with the common phrases Hillary and Trump will say during the debate and tweet along with #2016debatebingo www.presidentialdebatebingo.com" shortTitle="Have fun watching the debate! Play bingo with what Hillary &amp; Trump say! Tweet along with #2016debatebingo www.presidentialdebatebingo.com"/>
            </div>
        );
    }
    selectCard(evt) {
